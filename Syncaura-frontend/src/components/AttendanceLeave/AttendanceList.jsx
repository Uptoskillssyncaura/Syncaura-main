        ...
        {LeaveData.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              />
              <div className=" text-base text-[#000000] dark:text-[#F8F8F8] font-medium flex items-center justify-center basis-[28%] flex-wrap">
                <h1>{formattedDate(startDate)}</h1>
                <h1>{" - "}</h1>
                <h1>{formattedDate(endDate)}</h1>
              </div>
              <h1 className=" text-base text-[#000000] dark:text-[#F8F8F8] font-medium flex items-center justify-center basis-[20%]">
                {type}
              </h1>
              <h1 className=" text-base text-[#000000] dark:text-[#F8F8F8] font-medium flex items-center justify-start basis-[28%]">
                {reason}
              </h1>
              <div className="  flex items-center justify-center basis-[12%]">
                <div
              ...
              <div className="text-base font-medium flex items-center justify-center gap-2 basis-[12%]">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setCurrId(idx);
